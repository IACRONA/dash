...
if GetMapName() == "warsong" then
    ...
    -- Murder
    MURDER_SETTINGS_CRITICAL_CHANCE_DOUBLE = {1,1,2}
    MURDER_SETTINGS_CRITICAL_CHANCE_TRIPPLE = {1,1,2}
    MURDER_SETTINGS_CRITICAL_CHANCE_FOUR = {1,1,3}
...
if GetMapName() == "dash" then
    ...
    TIME_FOR_AMP_TOWERS_AND_CREEPS = 45000  --- 5 мин | время когда крипы и башни усиляются
    -- КРИПЫ:
...
if GetMapName() == "portal_trio" then
    ...
    -- Immortal
    IMMORTAL_SETTINGS_CHANCE_RESPAWN = {13,18,20}
    IMMORTAL_SETTINGS_CHANCE_EXPLOSION = {35,45,50}
    IMMORTAL_SETTINGS_DAMAGE = {720,890,1400}
    IMMORTAL_SETTINGS_CHANCE_BKB = {10,20,30}
    IMMORTAL_SETTINGS_DURATION_BKB = {2,3,4}
