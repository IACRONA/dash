...
if GetMapName() == "warsong" then
    ...
    ONE_PUNCHMAN_SETTINGS_COOLDOWN = 60
    ...
    IMMORTAL_SETTINGS_CHANCE_EXPLOSION = {40,50,60}
    IMMORTAL_SETTINGS_DAMAGE = {720,890,1200}
    IMMORTAL_SETTINGS_CHANCE_BKB = {10,20,30}
    IMMORTAL_SETTINGS_DURATION_BKB = {4,4,5}
    IMMORTAL_SETTINGS_COOLDOWN_BKB = {45,45,45}
...
if GetMapName() == "portal_duo" then
    ...
    ONE_PUNCHMAN_SETTINGS_COOLDOWN_KILL = 65
    ONE_PUNCHMAN_SETTINGS_DURATION = 20
