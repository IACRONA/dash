...
if GetMapName() == "dash" then
    ...
    BOOK_COMMON_COOLDOWN = 130 -- BOOK_COMMON_COOLDOWN = 130
    BOOK_RARE_START = 600 -- BOOK_RARE_START = 600
    BOOK_RARE_COOLDOWN = 220 -- BOOK_RARE_COOLDOWN = 220
    BOOK_EPIC_COOLDOWN = 600 -- BOOK_EPIC_COOLDOWN = 600
    BOOK_COMMON_LIMIT = 30
    BOOK_RARE_LIMIT = 15
    BOOK_EPIC_LIMIT = 5
