modifier_item_sapphire_gem = class({})
--------------------------------------------------------------------------------

function modifier_item_sapphire_gem:IsHidden()
    return true
end

function modifier_item_sapphire_gem:RemoveOnDeath()
    return false
end

--------------------------------------------------------------------------------

function modifier_item_sapphire_gem:IsPurgable()
    return false
end

--------------------------------------------------------------------------------

function modifier_item_sapphire_gem:OnCreated( kv )
...
function modifier_item_sapphire_gem:DeclareFunctions()
    local funcs =
    {
...
function modifier_item_sapphire_gem:GetModifierConstantManaRegen( params )
    return self.mana_regen_sec
end


function modifier_item_sapphire_gem:GetModifierMoveSpeedBonus_Constant( params )
    return self.bonus_movement_speed
end
--------------------------------------------------------------------------------

function modifier_item_sapphire_gem:GetModifierBonusStats_Intellect( params )
    return self.intellect_amount
end
-----------------------------------------------------------------------------------------

function modifier_item_sapphire_gem:OnAttackLanded( params )
    if IsServer() then
