function Spawn( entityKeyValues )
	...
	thisEntity:SetContextThink("BossRegenThink", function()
		...
		-- Дополнительная проверка: был ли получен урон недавно (атака башни/крипов)
		if not inCombat and thisEntity._last_damage_time then
			inCombat = (GameRules:GetGameTime() - thisEntity._last_damage_time) < 3.0
		end
