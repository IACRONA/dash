DONATE_ITEMS = {
    aura = {
        item_aura_aghanim = {
            modifier = "modifier_donate_aura_aghanim"
        },
        item_aura_autumn = {
    ...
    music = {
        item_music_pudge = {
            sound = "EndMusic.Pudge"
        },
        item_music_homelander = {
            sound = "EndMusic.Homelander"
        },
        item_music_i_love_everyone = {
            sound = "EndMusic.ILoveEveryone"
        },
        item_music_zombie_apokalipsis = {
            sound = "EndMusic.ZombieApokalipsis"
        },
        item_music_million_dollar_baby = {
            sound = "EndMusic.MillionDollarBaby"
        },
    },
