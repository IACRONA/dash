...
function StartMvp()
{
    ...
    Game.EmitSound("Flag.MvpBackground")
    $.Schedule( 0.5, () => 
    { 
...
function SpawnMvp(num, table_mvp)
{
    ...
    $.CreatePanel("DOTAScenePanel", mvp_panel_player, "hero_model", { class: "hero_model", drawbackground: false, unit:hero_name, particleonly:"false", antialias:"false",allowrotation:"true" });
