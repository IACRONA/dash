...
function ChangeCurrentSlide(n) {
    if (n == -1 || n == load.maxSlide || load.changeSlide == true)
        return;
    ...
    $.Schedule( 0.25, () => { load.hidd.style.backgroundColor = 'rgba(0, 0, 0, 0)' })
    $.Schedule( 0.35, () => { load.currentSlide = n; load.changeSlide = false })
